 ...
 */
angular.module('libs/translate', ['ng']).run([
  '$translate',
  function ($translate) {
...
angular.module('libs/translate').provider('$translate', [
  '$STORAGE_KEY',
...
angular.module('libs/translate').factory('$translateDefaultInterpolation', [
  '$interpolate',
...
angular.module('libs/translate').constant('$STORAGE_KEY', 'NG_TRANSLATE_LANG_KEY');
angular.module('libs/translate').directive('translate', [
  '$filter',
  '$interpolate',
  '$parse',
...
angular.module('libs/translate').filter('translate', [
  '$parse',
  '$translate',
